...
const JsonDataMapper = () => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "container", children: [(0, jsx_runtime_1.jsxs)("header", { children: [(0, jsx_runtime_1.jsx)("h1", { children: "JSON Data Mapper" }), (0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' }, children: [(0, jsx_runtime_1.jsxs)("p", { children: ["Selected: ", selectionCount, " layer(s)"] }), jsonData && ((0, jsx_runtime_1.jsx)("button", { onClick: handleClearData, style: {
                                    background: '#e74c3c',
                                    color: 'white',
                                    border: 'none',
                                    padding: '4px 8px',
