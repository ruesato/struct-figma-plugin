...
const ConfigurationModal = ({ isOpen, onClose, savedConfigs, loadConfiguration, saveConfiguration, deleteConfiguration, clearAllConfigurations, configName, setConfigName }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(dialog_1.Dialog, { open: isOpen, onOpenChange: onClose, children: (0, jsx_runtime_1.jsxs)(dialog_1.DialogContent, { className: "bg-[var(--figma-color-bg)] border-[var(--figma-color-border)] text-[var(--figma-color-text)] max-w-md p-0", children: [(0, jsx_runtime_1.jsx)(dialog_1.DialogHeader, { className: "p-6 pb-0", children: (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between", children: [(0, jsx_runtime_1.jsx)(dialog_1.DialogTitle, { className: "text-lg font-medium text-[var(--figma-color-text)]", children: "Saved configurations" }), (0, jsx_runtime_1.jsx)(button_1.Button, { variant: "ghost", size: "sm", onClick: onClose, className: "h-6 w-6 p-0 text-[var(--figma-color-text-secondary)] hover:text-[var(--figma-color-text)] hover:bg-[var(--figma-color-bg-secondary)]", children: (0, jsx_runtime_1.jsx)(lucide_react_1.X, { className: "h-4 w-4" }) })] }) }), (0, jsx_runtime_1.jsxs)("div", { className: "px-6 pb-6", children: [savedConfigs.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { className: "text-center py-8", children: (0, jsx_runtime_1.jsx)("p", { className: "text-[var(--figma-color-text-secondary)]", children: "No configurations saved yet." }) })) : ((0, jsx_runtime_1.jsxs)("div", { className: "space-y-2", children: [savedConfigs.map((config) => {
                                    var _a;
                                    return ((0, jsx_runtime_1.jsxs)("div", { className: `group flex items-center justify-between p-3 rounded-lg cursor-pointer transition-colors ${(selectedConfig === null || selectedConfig === void 0 ? void 0 : selectedConfig.name) === config.name
                                            ? 'bg-[var(--figma-color-bg-secondary)] ring-1 ring-[var(--figma-color-border)]'
                                            : 'hover:bg-[var(--figma-color-bg-secondary)]'}`, onClick: () => setSelectedConfig(config), children: [(0, jsx_runtime_1.jsx)("div", { className: "flex-1 min-w-0", children: (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-3", children: [(0, jsx_runtime_1.jsx)("div", { className: `w-4 h-4 rounded-full border-2 flex items-center justify-center ${(selectedConfig === null || selectedConfig === void 0 ? void 0 : selectedConfig.name) === config.name
                                                                ? 'border-[var(--figma-color-border-brand)] bg-[var(--figma-color-bg-brand)]'
                                                                : 'border-[var(--figma-color-border)]'}`, children: (selectedConfig === null || selectedConfig === void 0 ? void 0 : selectedConfig.name) === config.name && ((0, jsx_runtime_1.jsx)("div", { className: "w-2 h-2 bg-[var(--figma-color-text)] rounded-full" })) }), (0, jsx_runtime_1.jsxs)("div", { className: "flex-1 min-w-0", children: [(0, jsx_runtime_1.jsx)("p", { className: "text-sm font-medium text-[var(--figma-color-text)] truncate", children: config.name }), (0, jsx_runtime_1.jsxs)("p", { className: "text-xs text-[var(--figma-color-text-secondary)] truncate", children: [new Date(config.savedAt).toLocaleDateString(), " \u2022 ", config.dataSource, " \u2022 ", ((_a = config.mappings) === null || _a === void 0 ? void 0 : _a.length) || 0, " mappings"] })] })] }) }), (0, jsx_runtime_1.jsx)(button_1.Button, { variant: "ghost", size: "sm", onClick: (e) => {
                                                    e.stopPropagation();
